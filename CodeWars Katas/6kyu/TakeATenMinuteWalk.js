...
// one-letter strings representing directions to walk (eg. ['n', 's',
// 'w', 'e']). You know it takes you one minute to traverse one city
// block, so create a function that will return true if the walk the
// app gives you will take you exactly ten minutes (you don't want to
...
function isValidWalk(walk) {   
	var paths = {n:0,s:0,e:0,w:0};
	walk.forEach(function(walkValue){
	     paths[walkValue]++;   
	 });
  
  return paths["n"]===paths["s"] && paths["e"]===paths["w"] &&
