...
//
// Arguments 
// First argument (required): the original string to be converted. Second
// argument (optional): space-delimited list of minor words that must always be
// lowercase except for the first word in the string. Example

// titleCase('a clash of KINGS', 'a an the of') should return: 'A Clash of
// Kings' titleCase('THE WIND IN THE WILLOWS', 'The In') should return: 'The
// Wind in the Willows' titleCase('the quick brown fox') should return: 'The
// Quick Brown Fox'
